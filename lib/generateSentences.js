...
- 문장 난이도는 JLPT N2 수준을 중심으로 하되 가끔 N1 수준의 표현도 섞을 것. 한 문장은 6~14단어 내외로, 수동태·사역형·て형 활용·~ちゃう/~とく 같은 축약형 등 실제 회화에서 자주 쓰는 문법도 적극 포함할 것 (단, 경어체는 여전히 최소화)
...
- 각 항목은 다음 필드를 가진 JSON 객체:
  ...
  - jp: 일본어 문장 (한자+가나 혼용, 일본 현지인이 친구/동료 사이에서 실제로 쓰는 구어체·회화체. 명사 나열식 문장보다 동사·형용사 활용이 중심이 되는 자연스러운 문장 구조를 우선할 것. 문어체 느낌의 딱딱한 문장은 피할 것)
